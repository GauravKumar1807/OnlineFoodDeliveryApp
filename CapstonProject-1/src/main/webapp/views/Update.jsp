...
<!-- <iframe src="/views/UserNavbar.html" width="1400" height="85"></iframe>   -->
	<div>
		<br>
		<h2 class="text-center" style = "margin-top:8rem">Update Food  Details</h2>
		<br>
		<hr>
					...
					<div class="col">
						<div class="form-floating mb-3">
							<input type="text" class="form-control" name="foodName"
								...
								for="movieName" style="color:black ">Food Name</label>
						</div>
					</div>
					<br>
					<div class="col">
						...
						<div class="col">
							<div class="form-floating mb-3">
								<input type="text" class="form-control" name="foodQuantity"
									id="foodquantity" placeholder="Food Quantity" style="width: 30%; background:transparent;border:3px solid white;color:black"> <label
									for="foodQuantity" style="color:black">Food Release Data</label>
							</div>
						</div>	
